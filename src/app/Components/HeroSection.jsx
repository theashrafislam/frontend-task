        ...
        <div className='flex justify-between gap-3 relative'>
            <div className='w-[55%] pt-24'>
                ...
                <div className='mt-10'>
                    ...
                    {/* buy filter */}
                    {buy && <div className='bg-white p-6  drop-shadow-[-10px_0px_50px_rgba(0,0,0,0.10)] flex items-center justify-between gap-16 absolute z-10 w-[67%]'>
                        {/* location  */}
                    ...
                    {rent && <div className='bg-white p-6  drop-shadow-[-10px_0px_50px_rgba(0,0,0,0.10)] flex items-center justify-between gap-16 absolute z-10 w-[67%]'>
                        {/* location  */}
                        <div className='border-r-2 pr-5 border-[#E6E7E9]'>
                            <div className='flex items-center gap-1'>
                                <label htmlFor="location" className="text-[#030A1B] text-[16px] font-normal leading-normal">
                    ...
                    {sell && <div className='bg-white p-6  drop-shadow-[-10px_0px_50px_rgba(0,0,0,0.10)] flex items-center justify-between gap-16 absolute z-10 w-[67%]'>
                        {/* location  */}
                        <div className='border-r-2 pr-5 border-[#E6E7E9]'>
                            <div className='flex items-center gap-1'>
                                <label htmlFor="location" className="text-[#030A1B] text-[16px] font-normal leading-normal">
