        ...
        <div className='flex lg:flex-row flex-col-reverse justify-between gap-3 relative'>
            <div className='w-[100%] lg:w-[55%] pt-12 lg:pt-24'>
                ...
                <div className="sm:flex lg:hidden flex items-center justify-center text-center">
                    <h1 className="text-[#030A1B] text-[20px] font-semibold max-w-xs">
                        Find the perfect place to stay with your family
                    </h1>
                </div>
                <p className='text-[#030A1B] text-base lg:text-[18px] not-italic font-medium text-center lg:text-start leading-[27px] mt-7'>Buying a home is a life-changing experience, so shouldn’t <br /> your real estate agent be a life changer.</p>
                ...
                <div className='mt-10'>
                    ...
                    {/* buy filter */}
                    {buy && <div className='bg-white p-6  drop-shadow-[-10px_0px_50px_rgba(0,0,0,0.10)] flex flex-col lg:flex-row items-center justify-between gap-16 absolute z-10 w-full lg:w-[67%]'>
                        {/* location  */}
                    ...
                    {rent && <div className='bg-white p-6  drop-shadow-[-10px_0px_50px_rgba(0,0,0,0.10)] flex flex-col lg:flex-row items-center justify-between gap-16 absolute z-10 w-full lg:w-[67%]'>
                        {/* location  */}
                        <div className='border-r-2 pr-5 border-[#E6E7E9]'>
                            <div className='flex items-center gap-1'>
                                <label htmlFor="location" className="text-[#030A1B] text-[16px] font-normal leading-normal">
                    ...
                    {sell && <div className='bg-white p-6  drop-shadow-[-10px_0px_50px_rgba(0,0,0,0.10)] flex items-center justify-between gap-16 absolute z-10 w-full lg:w-[67%]'>
                        {/* location  */}
                        <div className='border-r-2 pr-5 border-[#E6E7E9]'>
                            <div className='flex items-center gap-1'>
                                <label htmlFor="location" className="text-[#030A1B] text-[16px] font-normal leading-normal">
                            ...
                            <select
                                ...
                                className="appearance-none mt-1 block w-full pl-1 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
                            >
                                <option value="Dhaka">Nawabgonj</option>
                                <option value="Chittagong">Nawabgonj</option>
                                <option value="Sylhet">Sylhet</option>
                                <option value="Rajshahi">Rajshahi</option>
                                <option value="Khulna">Khulna</option>
                            </select>
                        ...
                        <div className='pr-10 border-r-2 border-[#E6E7E9]'>
                            ...
                            <select
                                ...
                                className="appearance-none mt-1 block w-full pl-1 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
                            >
                                <option value="Duplex">Nawabgonj</option>
                                <option value="Duplex 2">Nawabgonj 2</option>
                                <option value="Duplex 3">Nawabgonj 3</option>
                                <option value="Duplex 4">Nawabgonj 4</option>
                                <option value="Duplex 5">Nawabgonj 5</option>
                            </select>
                        </div>
                        {/* Price  */}
                        <div>
